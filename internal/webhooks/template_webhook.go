...
//+kubebuilder:webhook:path=/validate-cosmo-workspace-github-io-v1alpha1-template,mutating=false,failurePolicy=fail,sideEffects=None,groups=cosmo-workspace.github.io,resources=clustertemplates,verbs=create;update,versions=v1alpha1,name=vtemplate.kb.io,admissionReviewVersions={v1,v1alpha1}
...
func (h *TemplateValidationWebhookHandler) validateWorkspace(ctx context.Context, ws *cosmov1alpha1.Workspace) error {
