...
{{- $altNames := list ( printf "%s.%s.svc" "cosmo-dashboard" .Release.Namespace ) ( printf "%s.%s.svc.cluster.local" "cosmo-dashboard" .Release.Namespace ) ( printf "%s" .Values.cert.certManager.dnsName ) -}}
